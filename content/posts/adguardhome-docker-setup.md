...
## PART1 服务端环境准备 
<pre class="wp-block-code"><code>Debian,docker,AdguardHome镜像源
主机IP:192.168.5.200
镜像源可以自行查找</code></pre>
<p class="wp-block-paragraph">
...
<pre class="wp-block-code"><code>dog@debian:~/adguard$ docker ps  |grep adguard
...
<pre class="wp-block-code"><code>https:&#47;&#47;dns.alidns.com/dns-query
...
<pre class="wp-block-code"><code>||dns.weixin.qq.com.cn^
应用即可</code></pre>
<p class="wp-block-paragraph">
</p>
## PART2 路由器 
